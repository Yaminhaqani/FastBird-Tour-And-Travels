...
const ContactForm = () => {
  ...
  return (
    <section className=" w-full flex flex-col items-center">
        <div className="relative w-dvw md:w-[95%] lg:w-[82%] rounded-2xl overflow-hidden mt-4 pb-4 border" style={{backgroundImage: `url(/heroImages/glass2.webp)`, backgroundSize: "cover",
      ...
      >
        ...
        transition={{duration: 1}}
         className="text-center">
            <h1 className="text-3xl tracking-tight text-amber-300 font-bold z-50">Contact Us</h1>
        </motion.div>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea placeholder="Your message" {...field} rows={4} name="message" />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
