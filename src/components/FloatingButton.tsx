...
const FloatingButton = () => {
  ...
  return (
   <div className="fixed bottom-30 md:bottom-10 right-4 z-50">
  <div className="relative">
    <AnimatePresence>
      {visible && (
        ...
        >
          <GlassIcons items={items} className="text-xs text-black [text-shadow:1px_1px_0_white,-1px_1px_0_white,1px_-1px_0_white,-1px_-1px_0_white]" />
        </motion.div>
      )}
    </AnimatePresence>

{/* Group tells tailwind that child elements can react when this element is hovered */}
